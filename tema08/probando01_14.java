...
//    System.out.print("Introduce un número entero positivo: ");
//    n = s.nextInt();
//    int p = Ejercicio01.siguientePrimo(n);
//    System.out.println("El siguiente número primo es " + p);
...
//    int e = s.nextInt();
//    int resultado = Ejercicio01.potencia(n, e);
...
//    System.out.print("Introduce un número entero positivo: ");
//    n = s.nextInt();
//    int conteo = Ejercicio01.digitos(n);
...
//    System.out.print("Introduce un número entero positivo: ");
//    n = s.nextInt();
//    int volteo = Ejercicio01.voltea(n);
...
//    int p = s.nextInt();
//    int digito = Ejercicio01.digitoN(n, p);
...
//    d = s.nextInt();
//    r = Ejercicio01.posicionDigito(n, d);
...
//    d = s.nextInt();
//    r = Ejercicio01.quitaPorDetras(n, d);
...
//    System.out.print("¿Cuantos dígitos quieres quitar?: ");
//    d = s.nextInt();
//    r = Ejercicio01.quitaPorDelante(n, d);
//    System.out.println("El resultado es: " + r);
...
//    d = s.nextInt();
//    r = Ejercicio01.pegaPorDetras(n, d);
//    System.out.println("El resultado es: " + r);
...
//    d = s.nextInt();
//    r = Ejercicio01.pegaPorDelante(n, d);
//    System.out.println("El resultado es: " + r);
...
//    f = s.nextInt();
//    r = Ejercicio01.trozoDeNumero(n, i, f);
//    System.out.println("El resultado es: " + r);
...
//    i = s.nextInt();
//    r = Ejercicio01.juntaNumeros(n, i);
//    System.out.println("El resultado es: " + r);
    System.out.println("");
  }
}